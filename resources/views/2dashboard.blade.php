    ...
    <div class="sidebar">
        <div class="sidebar-content">
            <div class="logo-container d-flex align-items-center">
                <div class="bg-amber rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                    <i class="bi bi-shop text-congress-blue fs-5"></i>
                </div>
                <div class="ms-2 logo-text">
                    <h5 class="mb-0 fw-bold text-congress-blue">ATIN STORE</h5>
            ...
            <ul class="nav flex-column mt-4">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#collapseUser">
                    ...
                    <div class="collapse" id="collapseUser">
                        <div class="nav flex-column">
                            <a class="nav-link sub-link" href="#">
                                <i class="bi bi-circle sub-icon me-2"></i>
                                <span>Users</span>
                            </a>
                            <a class="nav-link sub-link" href="#">
                                <i class="bi bi-circle sub-icon me-2"></i>
